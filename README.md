<h1 align="center">Volodymyr Shynkarov</h1>
...
<p align="center">
  <a href="https://voldemlive.github.io">Portfolio</a>
  ·
...
### [App Factory](https://voldemlive.github.io/work/app-factory.html)

A mobile-first system for building and evolving applications on a shared React Native and Nx foundation.

`React Native` `Nx` `PocketBase` `Fastlane` `GitHub Actions`
...
### [Keyword Graph Explorer](https://voldemlive.github.io/work/keyword-graph-explorer.html)
...
`TypeScript` `Fastify` `OpenAI` `MCP` `SQLite`
